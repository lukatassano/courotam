    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-col justify-start pt-10 md:pt-20 md:gap-10"
          >
            <div className="sticky flex flex-col z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-m font-bold text-neutral-100 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
