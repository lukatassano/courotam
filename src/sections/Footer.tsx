...
export const Footer = () => {
  return (
    <footer className="flex w-full py-12 bg-black text-white/60 ">
      <div className="w-full bg-zinc-900 m-4 flex py-16 px-24 items-center justify-between border-dashed/white rounded-lg">
        ...
        <div className="flex">
          <ul className="flex flex-col justify-center gap-2.5">
            ...
            <div className="flex items-center gap-6">
              <li>
                <a href="mailto:courotam@gmail.com?subject=Proposta%20de%20Negócio&body=Olá,%20gostaria%20de%20discutir%20uma%20proposta%20de%20negócio.%0A%0AFico%20no%20aguardo%20da%20resposta.">
                  <MdOutlineEmail className="text-white h-10 w-10 transform transition duration-300 ease-in-out hover:scale-110" />
                </a>
              </li>
              <li>
                <a href="https://wa.me/5551981140155?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20seus%20serviços.">
